...
typedef void* (*malloc_func_ptr)( size_t);
typedef void (*free_func_ptr)(void*);
typedef void* (*realloc_func_ptr)( void*, size_t);
...
void* malloc(size_t size) {
    ...
    real_malloc = (malloc_func_ptr)dlsym(RTLD_NEXT, "malloc");
...
void free(void* ptr) {
    ...
    real_free = (free_func_ptr)dlsym(RTLD_NEXT, "free");
...
void* realloc(void* ptr, size_t size) {
    ...
    real_realloc = (realloc_func_ptr)dlsym(RTLD_NEXT, "realloc");
    void* old_chunk = ptr;
